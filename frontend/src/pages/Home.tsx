...
const steps = [
  {
    number: "01",
    icon: Fingerprint,
    text: "The agent gets an ERC-8004 identity and a human-readable ENS name, becoming its persistent, ownable identity on chain.",
  },
  {
    number: "02",
    icon: Send,
  ...
  return (
    <MotionConfig reducedMotion="user">
      <div className="landing bg-white font-sans text-brand-black">
        ...
        <section id="how-it-works" className="mx-auto max-w-5xl px-7 pt-28 pb-16">
          ...
          <Card className="mt-10 flex items-center gap-4 p-6">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-brand-mint">
              <MessageSquare size={20} strokeWidth={1.5} className="text-brand-black" />
            </div>
        ...
        <section id="faq" className="mx-auto max-w-3xl px-7 pt-16 pb-28">
          <div className="mb-16">
